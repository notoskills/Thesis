...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/messaufbau}
...
\footnotesize
  ...
  \begin{tabular}{p{0.22\textwidth} p{0.48\textwidth} p{0.20\textwidth}}
    ...
    Topics & Zur Laufzeit angelegt; Vertrauens-Topic mit gesetztem \texttt{submitKey}, übrige Topics offen & innerhalb \\
...
% TODO Feststellung eintragen, sobald der Protokollstand beider Arme geprueft ist; bei Nichterfuellung greift die in 4.5.5 vorgesehene zweigeteilte Einloesung von NFA7 (Zugriffskontrolle experimentell ueber S5, Widerruf ueber die Pruefung der eindeutigen Auswertbarkeit des Akkumulatorzustands)
