...
Als Kennzahl der Lage dient durchgehend der Median, als Streuungsmaß die skalierte mittlere absolute Abweichung. Mittelwert und Standardabweichung werden nicht verwendet, da die beobachteten Verteilungen schwere Ränder aufweisen und einzelne Ausreißer die Standardabweichung dominieren würden, ohne dass sich das typische Verhalten geändert hätte. Aus demselben Grund werden auch die beiden statistischen Prüfungen über Ränge geführt: der Wilcoxon-Vorzeichen-Rang-Test für den Vergleich gepaarter Messreihen anstelle des normalverteilungsabhängigen t-Tests, und der Rangkorrelationskoeffizient nach Spearman für die Prüfung, ob die Messwerte über die Laufreihenfolge hinweg systematisch steigen oder fallen. Beide sind gegenüber Ausreißern unempfindlich, weil ein extremer Wert lediglich den äußersten Rang belegt. Diese Trendprüfung ist keine Formalie: Sie hat eine kontaminierte Messreihe aufgedeckt, deren Werte systematisch anstiegen, weil die jeweils andere Variante noch Arbeitsspeicher belegte; die Serie wurde verworfen und unter der in Abschnitt~\ref{sec:impl-betrieb} beschriebenen Ein-Varianten-Regel neu erhoben.
