...
\paragraph{Entscheidung.}
Die Vertrauenshierarchie wird auf einem einzelnen Topic geführt, dessen \texttt{submitKey} als Threshold Key von den Steward-Instanzen gemeinsam kontrolliert wird und die Registrierung neuer Steward-Akteure netzwerkseitig absichert. Endorser-Rechte werden über signierte Delegationsnachrichten auf demselben Topic vergeben; ihre Gültigkeit prüft der Registry-Adapter als auswertende Komponente des in E5 festgelegten Lesewegs, indem er die Historie des Vertrauens-Topics bei jeder Prüfung erneut ausliest, bevor er nachfolgende Registrierungsnachrichten des betreffenden Akteurs als gültig akzeptiert. Falls der Delegationszustand nicht lesbar ist, wird die Nachricht als ungültig behandelt. Die in FA5 geforderte topicübergreifende Historie wird aus den Konsens-Zeitstempeln der beteiligten Topics rekonstruiert; der dafür nötige Aufwand geht in die Messung nach NFA2 und NFA3 ein.
...
Die Abbildung~\ref{fig:zielarchitektur} fasst die Topics zu einer Komponente zusammen, obwohl sie durch die Entscheidungen E3, E4 und E6 unterschiedlich strukturiert sind. Die Abbildung~\ref{fig:topic-struktur} differenziert sie nach ihrem Inhalt und ihrer Anzahl aus. Von den sechs Topic-Typen wachsen nur zwei über die Zeit: das Vertrauens-Topic mit jeder Änderung der Delegationsrechte und das Topic des Widerrufsstatus mit jedem Widerruf. Die übrigen vier bleiben nach ihrer Veröffentlichung unverändert. Für die Evaluation nach NFA5 ist diese Unterscheidung wesentlich, da der in E5 festgelegte Leseweg nur bei den wachsenden Topics mit dem Bestand teurer wird.
