...
Der Ressourcenverbrauch nach NFA3 ist nicht als eigenes Szenario vorgesehen, sondern soll begleitend in allen Szenarien erhoben werden; ob diese Absicht eingelöst wurde, weist Abschnitt~\ref{sec:results-ressourcen} aus. Die Bedrohungsresistenz nach NFA8 wird nicht experimentell, sondern analytisch bewertet.
