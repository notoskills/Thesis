...
\footnotesize
  ...
  \begin{tabular}{p{0.14\textwidth} p{0.33\textwidth} p{0.19\textwidth} p{0.16\textwidth}}
    ...
    NFA2 - Latenz & Dauer von der Einreichung bis zur Finalität (Schreiben) bzw. von der Anfrage bis zur Antwort (Lesen), berichtet als Median und 95. Perzentil & VDR-Schnittstelle, Zustandskomponente & \cite{manoj2022, torongo2023, mamoru2026, satybaldy2026} \\
    ...
    NFA5 - Datenwachstum & Speicherbedarf je Konsensknoten, je Mirror Node und je materialisiertem Zustand in Abhängigkeit von der Anzahl verwalteter Identitätsobjekte & Konsensknoten, Mirror Node, Zustandskomponente & \cite{mazlan2020, giao2026, mamoru2026, farin2025} \\
    ...
    NFA7 - Zugriffskontrolle und Widerruf & Ergebnis nicht autorisierter Schreibversuche; Verifikationsergebnis vor und nach dem Widerruf; Zeit bis zur Wirksamkeit des Widerrufs & Zustandskomponente, Agent & \cite{mamoru2026, torongo2023, tawfik2025} \\
