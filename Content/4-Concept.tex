...
\paragraph{Problem.}
Da HCS keinen Zustand speichert, muss definiert werden, was überhaupt als Nachricht auf den Ledger geschrieben wird: die Identitätsobjekte selbst oder nur ein Verweis auf sie. Diese Entscheidung geht den Entscheidungen über die einzelnen Objekttypen voraus, da sie bestimmt, welche Methoden für diese Objekttypen überhaupt in Frage kommen.
...
\footnotesize
  ...
  \begin{tabular}{p{0.19\textwidth} p{0.44\textwidth} p{0.24\textwidth}}
    ...
    Vollständige Kodierung der Identitätsobjekte auf dem Ledger; kein
    Hash-Anchoring &
