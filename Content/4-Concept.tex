...
\footnotesize
  ...
  \begin{tabular}{p{0.19\textwidth} p{0.44\textwidth} p{0.24\textwidth}}
    ...
    Bestehende Hedera-Plugin des Aries-Agentenframeworks über die Verifiable-Data-Registry-Schnittstelle von AnonCreds &
    FA6; NFA3 \\
    \bottomrule
  \end{tabular}
\end{table}
...
Für das Zusammenspiel dieser Komponenten ist eine Eigenschaft festzuhalten, die die HCS-basierte Variante von der Referenzvariante unterscheidet: Auf dem Schreibweg ist keine zustandsführende Komponente beteiligt. Das Netzwerk prüft ausschließlich die Berechtigung über den \texttt{submitKey} (E6), ordnet die Nachricht und stellt sie über die Mirror Node bereit; die gesamte inhaltliche Auswertung einschließlich der Prüfung der Delegationskette fällt auf den Lesezeitpunkt (E5). Der Aufwand des Lesewegs wächst deshalb mit der Länge der Topic-Historie - genau der Zusammenhang, den die Evaluation nach NFA2 und NFA5 quantifiziert.
...
\footnotesize
  ...
  \begin{tabular}{p{0.14\textwidth} p{0.33\textwidth} p{0.19\textwidth} p{0.16\textwidth}}
    ...
    NFA7 - Zugriffskontrolle & Ergebnis nicht autorisierter Schreibversuche, getrennt nach netzwerkseitiger und anwendungsseitiger Prüfung; der Widerruf wird auf Entwurfsebene statt messend bewertet (Abschnitt~\ref{subsec:eval-validitaet}) & VDR-Schnittstelle & \cite{mamoru2026, torongo2023, tawfik2025} \\
