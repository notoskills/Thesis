...
Die funktionalen Anforderungen entscheiden, ob die Substitution überhaupt gelungen ist. Fünf von sechs sind vollständig erfüllt, eine nur teilweise.

\paragraph{FA2, FA3 und FA4 -- Verwaltung von Bezeichnern, Schemas, Credential Definitions und Widerrufsinformationen.} Diese drei Anforderungen sind auf der HCS-Variante vollständig erfüllt, und der Nachweis ist jeweils eine ausgeführte Operation und keine Zusicherung. Die Basismessung hat für jede dieser Objektgruppen Schreib- und Lesevorgänge in beiden Varianten durchgeführt und mit Werten belegt (Abschnitt~\ref{sec:results-s1}); die Widerrufs-Probe hat zusätzlich die Anlage einer Registry, den Ersteintrag, den eigentlichen Widerruf und die Rücklesung des Akkumulatorzustands einzeln ausgeführt (Abschnitt~\ref{sec:results-s5}). Die abgerufenen Objekte entsprechen dem AnonCreds-Datenmodell, da die Hiero AnonCreds Method in ihrer spezifizierten Form verwendet wird (E4) und die Agentenschicht sie unverändert weiterverarbeitet.
